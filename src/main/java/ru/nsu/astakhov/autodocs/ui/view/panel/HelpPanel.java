...
//        helpPanel.setOpaque(false);
        ...
        java.util.List<String> helpItems = List.of(
                ...
                "$(соруководительВКР.имя)\t – ФИО соруководителя ВКР. Пример: Иванов Иван Иванович",
                ...
                "$(видПрактики)\t – название вида практики. Пример: Учебная практика (ознакомительная практика)",
                "$(видПрактикиРодительный)\t – название вида практики в родительном падеже с маленькой буквы (для Индивидуального Задания, Отзыва, Отчета)\nПример: учебной практики (ознакомительной практики)",
                "$(видПрактикиВинительный)\t – название вида практики в винительном падеже с маленькой буквы (для Заявления На Практику)\nПример: учебную практику (ознакомительную практику)",
