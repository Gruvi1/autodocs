...
@Service
public class ApplicationInternshipMast2SemItGenerator extends AbstractDocumentGenerator {
    ...
    public ApplicationInternshipMast2SemItGenerator(RussianWordDecliner decliner) {
        super(decliner, OUTPUT_FILE_NAME, TEMPLATE_PATH, OUTPUT_DIRECTORY, PLACEHOLDERS);
    }

    @Override
    public GeneratorType getType() {
        return GeneratorType.APPLICATION_INTERNSHIP_MAST_2SEM_IT;
    }
}
