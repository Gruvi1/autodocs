...
@Service
public class InternshipSupervisorReviewBach7SemSecsGenerator extends AbstractDocumentGenerator {
    private static final String OUTPUT_FILE_NAME = "Отзыв_руководителя_практики_Бакалавриат_ПИиКН_7сем.docx";
    ...
    public InternshipSupervisorReviewBach7SemSecsGenerator(RussianWordDecliner decliner) {
        super(decliner, OUTPUT_FILE_NAME, TEMPLATE_PATH, OUTPUT_DIRECTORY, PLACEHOLDERS);
    }

    @Override
    public GeneratorType getType() {
        return GeneratorType.INTERNSHIP_SUPERVISOR_REVIEW_BACH_4COURSE_SECS;
    }
}
