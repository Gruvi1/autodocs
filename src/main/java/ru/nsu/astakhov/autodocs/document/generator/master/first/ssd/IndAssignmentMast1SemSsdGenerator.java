...
@Service
public class IndAssignmentMast1SemSsdGenerator extends AbstractDocumentGenerator {
    private static final String OUTPUT_FILE_NAME = "ИЗ_на_практику_Магистратура_ТРПС_1сем.docx";
    ...
    public IndAssignmentMast1SemSsdGenerator(RussianWordDecliner decliner) {
        super(decliner, OUTPUT_FILE_NAME, TEMPLATE_PATH, OUTPUT_DIRECTORY, PLACEHOLDERS);
    }

    @Override
    public GeneratorType getType() {
        return GeneratorType.INDIVIDUAL_ASSIGNMENT_MAST_1COURSE_SSD;
    }
}