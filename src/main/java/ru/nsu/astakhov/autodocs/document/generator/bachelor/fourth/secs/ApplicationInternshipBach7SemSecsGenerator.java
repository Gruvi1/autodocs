...
@Service
public class ApplicationInternshipBach7SemSecsGenerator extends AbstractDocumentGenerator {
    private static final String OUTPUT_FILE_NAME = "Заявление_на_практику_Бакалавриат_7сем.docx";
    ...
    public ApplicationInternshipBach7SemSecsGenerator(RussianWordDecliner decliner) {
        super(decliner, OUTPUT_FILE_NAME, TEMPLATE_PATH, OUTPUT_DIRECTORY, PLACEHOLDERS);
    }

    @Override
    public GeneratorType getType() {
        return GeneratorType.APPLICATION_INTERNSHIP_BACH_7SEM_SECS;
    }
}
