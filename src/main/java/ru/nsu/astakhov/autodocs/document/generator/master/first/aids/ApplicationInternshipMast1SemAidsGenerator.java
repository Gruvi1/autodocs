...
@Service
public class ApplicationInternshipMast1SemAidsGenerator extends AbstractDocumentGenerator {
    ...
    public ApplicationInternshipMast1SemAidsGenerator(RussianWordDecliner decliner) {
        super(decliner, OUTPUT_FILE_NAME, TEMPLATE_PATH, OUTPUT_DIRECTORY, PLACEHOLDERS);
    }

    @Override
    public GeneratorType getType() {
        return GeneratorType.APPLICATION_INTERNSHIP_MAST_1SEM_AIDS;
    }
}