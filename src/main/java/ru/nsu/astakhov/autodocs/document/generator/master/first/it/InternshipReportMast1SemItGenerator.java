...
@Service
public class InternshipReportMast1SemItGenerator extends AbstractDocumentGenerator {
    private static final String OUTPUT_FILE_NAME = "Отчет_о_практике_Магистратура_IoT_1сем.docx";
    ...
    public InternshipReportMast1SemItGenerator(RussianWordDecliner decliner) {
        super(decliner, OUTPUT_FILE_NAME, TEMPLATE_PATH, OUTPUT_DIRECTORY, PLACEHOLDERS);
    }

    @Override
    public GeneratorType getType() {
        return GeneratorType.INTERNSHIP_REPORT_MAST_1COURSE_IT;
    }
}
